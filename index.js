...
// Define the fixedTo function
function fixedTo(x, value) {
    return parseFloat(value).toFixed(x);
}

// Initialize the precision level
var precision = 2; // You can change this value to 0, 1, 2, 3, 4, or 5 to test different precisions
